...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col bg-pink-200 items-center justify-between">
      <section className='flex flex-col h-screen justify-between items-center w-screen p-24'>
        ...
        <h1 className={`text-4xl lg:text-8xl font-bold text-center ${ephesis.className}`}>Wedding Planner</h1>
